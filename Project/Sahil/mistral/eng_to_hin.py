...
tokenizer = AutoTokenizer.from_pretrained("mistralai/Mistral-7B-v0.1",cache_dir="/raid/home/chinmayjain/Sahil/NLP_Project/mistral/model",token = access_token)
model = AutoModelForCausalLM.from_pretrained("mistralai/Mistral-7B-v0.1",cache_dir="/raid/home/chinmayjain/Sahil/NLP_Project/mistral/model", device_map="auto",token = access_token)
