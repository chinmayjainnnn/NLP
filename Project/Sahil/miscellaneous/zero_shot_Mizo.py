...
english_file = '/data5/home/sahilm/NLP_Project/Dataset/IndicNECorp1.0/English-Mizo/parallel/en-lus-valid-en.txt'
gujarati_file = '/data5/home/sahilm/NLP_Project/Dataset/IndicNECorp1.0/English-Mizo/parallel/en-lus-valid-lus.txt'
...
total_bleu_score = 0
max_bleu_score = 0
with open("zero_shot_Mizo_output.txt", 'w') as f:
    ...
    for batch in train_loader:
        ...
        for i in range(len(batch[0])):
            ...
            print("Mizo: " + reference)
            print("Mizo: " + reference, file=f)
            examples = f"""Examples:\nLet us choose for us that which is right .  Let us know among ourselves what is good . => A dik chu thlang ila ,  Kan tâna chu i thlang .  tlâng ang u . \nthat Christ may dwell in your hearts through faith ;  to the end that you ,  being rooted and grounded in love , => rinna avângin Krista chu in thinlungah chêng sela ,  hmangaihnaah zung kaiin phun ngheh in ni dâwn nia .\n\n"""
            template = examples + f"""Translate the following text to Mizo:\nText: {text}\nOutput: """    
