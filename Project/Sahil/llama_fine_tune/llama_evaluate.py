...
new_model = "llama-2-7b-translation-2-epochs-10K-Sahil"
...
tokenizer = AutoTokenizer.from_pretrained(model_name, cache_dir="/data5/home/sahilm/NLP_Project/Llama_2_7b_chat_hf", trust_remote_code=True, token = access_token)
...
dataset_name = "/data5/home/sahilm/NLP_Project/Dataset/fine_tune_dataset.txt"
# valid_dataset = load_dataset("text", data_files={"validation": [f"{dataset_name}"]})

english_file = '/data5/home/sahilm/NLP_Project/Dataset/English.txt'
hindi_file = '/data5/home/sahilm/NLP_Project/Dataset/Hindi.txt'
...
for i in tqdm(range(5)):#tqdm(range(len(valid_dataset['validation']))):
    ...
    output = model.generate(inputs=input_ids, temperature=0.1, stopping_criteria=stopping_criteria, max_new_tokens=512, repetition_penalty=1.1)
