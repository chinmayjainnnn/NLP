...
with open("/data5/home/sahilm/NLP_Project/Dataset/instruction_dataset/Hindi.txt", "w") as output_file:
...
with open("/data5/home/sahilm/NLP_Project/Dataset/instruction_dataset/English.txt", "w") as output_file:
    # Write the lines to the output file
    for line in lines:
        output_file.write(line)
